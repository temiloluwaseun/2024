...
print("My name is "+ name.capitalize() +" . I am "+ age +" years old. I am a resident of " + address.capitalize() +". I struggle with"+ struggle.lower() +
      ". It is sad but I find my way through it and I've been "+ help.lower()+ " to help myself get better and its helping. In all I am still very greatful for life and the love shown by those around me")
